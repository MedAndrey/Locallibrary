...
class Genre(models.Model):
	name = models.CharField('Жанр', max_length = 200, help_text = "Напишите жанр книги(пример: Научная фантастика, Русская поэзия и др.)" )
...
class Book(models.Model):
	...
	summary = models.TextField('Резюме', max_length = 1000, help_text = "Введите краткое описание книги" )
	isbn = models.CharField('ISBN', max_length = 13, help_text = '13 символов <a href="https://www.isbn-international.org/content/what-isbn">номера ISBN</a>')
